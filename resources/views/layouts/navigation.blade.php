<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <<<<<<< HEAD <a href="{{ route('api.test') }}">
                        =======
                        <a href="{{ route('dashboard') }}">
                            >>>>>>> 2653b6a5465cd6ffa19143c5f1568d8cae77d531
                ...
                <<<<<<< HEAD <!-- 🔽 完了一覧ページへのリンクを追加 <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('todo.finished_list')" :active="request()->routeIs('todo.finished_list')">
                        {{ __('完了タスク一覧') }}
                    </x-nav-link>
            </div>-->
            =======
            <!-- 🔽完了課題一覧ページへのリンクを追加 -->
            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <x-nav-link :href="route('todo.finishedList')" :active="request()->routeIs('todo.finishedList')">
                    {{ __('完了タスク一覧') }}
                </x-nav-link>
            </div>
            >>>>>>> 2653b6a5465cd6ffa19143c5f1568d8cae77d531
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <!--  完了一覧ページへのリンクを追加 -->
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('todo.finishedList')" :active="request()->routeIs('todo.finishedList')">
                {{ __('完了タスク一覧') }}
            </x-responsive-nav-link>
        </div>
        <!--  作成ページへのリンクを追加 -->
